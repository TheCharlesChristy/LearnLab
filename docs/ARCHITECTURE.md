...
| `src/experience/` | v2 course-pack and experience-graph TypeScript contracts (`docs/EXPERIENCE_RUNTIME_V2_SCHEMA.md`). B2 graph discovery/semantic validation and deterministic indexes live in the content build; runtime traversal arrives in B3. | build validation only |
