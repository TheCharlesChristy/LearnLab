...
export function progressMock() {
  return {
    ...
    seedReviewItem: vi.fn(async () => undefined),
    dueReviewItems: vi.fn(async (): Promise<unknown[]> => []),
    useDueReviewCount: vi.fn((): number | undefined => 0),
    useDueReviewItems: vi.fn((): unknown[] | undefined => []),
    useAllReviewItems: vi.fn((): unknown[] | undefined => []),
